...
class GiftedChat extends Component {
  constructor(props) {
    ...
    this._messagesContainerHeight = this.state.messagesContainerHeight;
  ...
  onKeyboardWillHide() {
    ...
    if (this.props.isAnimated === true) {
      var an = Animated.timing(this.state.messagesContainerHeight, {
        toValue: newMessagesContainerHeight,
        duration: 210,
      }).start();
    } else {
      ...
      onLayout={(e) => {
        ...
        InteractionManager.runAfterInteractions(() => {
          this.setState({
            ...
            text: '',
            composerHeight: MIN_COMPOSER_HEIGHT,
            messagesContainerHeight: this.prepareMessagesContainerHeight(this.getMaxHeight() - this.getMinInputToolbarHeight() - 1.5),
          });
        });
      }}
        >
